    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 animate-fadeIn" id="resume-hub-view">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="inline-block rounded-sm border border-orange-500/20 bg-orange-500/10 px-4 py-1.5 font-mono text-[14px] font-bold text-orange-400 uppercase tracking-widest">
          ...
          <p className="font-mono  text-orange-500 uppercase tracking-widest font-bold">
            {profile.title}
          </p>
        ...
        <div className="rounded-sm border border-white/5 bg-white/[0.02] p-6 self-start space-y-5">
          <div className="pb-3 border-b border-white/5 flex items-center justify-between">
            <h3 className="font-display font-bold text-[16px] text-zinc-400 uppercase tracking-widest">
              Hiring Coordinates
            </h3>
            <span className="font-mono text-[16px] bg-green-500/10 text-green-400 border border-green-500/20 px-1.5 py-0.5 rounded-sm uppercase tracking-widest font-bold">
              Active SLA
            </span>
          </div>
          ...
          <div className="space-y-3.5  font-mono uppercase tracking-widest text-[16px] font-bold">
          ...
          <div className="pt-3 border-t border-white/5 flex flex-col gap-2">
            <a
              ...
              className="flex items-center justify-center space-x-2 rounded-sm bg-white hover:bg-orange-500 py-3 text-center  font-bold uppercase tracking-widest text-zinc-950 hover:text-white shadow-lg transition-colors duration-300"
            >
            ...
            <a
              ...
              className="flex items-center justify-center space-x-2 rounded-sm border border-white/5 bg-white/[0.02] hover:bg-white/[0.05] hover:border-orange-500/30 p-3  font-bold uppercase tracking-widest text-[#dfdfdf] hover:text-white transition-all"
            >
            ...
            <button
              ...
              className="flex items-center justify-center space-x-2 rounded-sm border border-orange-500/20 bg-orange-500/[0.03] hover:bg-orange-500/[0.08] hover:border-orange-500 p-3  font-bold uppercase tracking-widest text-orange-400 hover:text-white transition-all cursor-pointer"
            >
              <FileText className="h-4 w-4 shrink-0 animate-pulse" />
              <span>Export CV to professional PDF</span>
            </button>
            <p className="text-[15px] font-mono font-bold uppercase tracking-wider text-zinc-400 text-center mt-1 leading-normal">
          ...
          <div className="space-y-8 relative pl-6 border-l border-white/5">
            ...
            <div className="relative">
              ...
              <div className="space-y-1.5">
                <span className="font-mono  font-bold text-orange-500">2023 — Present</span>
                ...
                <p className="text-zinc-400  font-mono uppercase tracking-widest">Remote • Worldwide Contracts</p>
                <p className="text-zinc-400  leading-relaxed font-sans mt-2">
            ...
            <div className="relative">
              ...
              <div className="space-y-1.5">
                <span className="font-mono  font-bold text-zinc-450">2018 — 2023</span>
                ...
                <p className="text-zinc-400  font-mono uppercase tracking-widest">Dhaka Sector & Remote Coordinates</p>
                <p className="text-zinc-400  leading-relaxed font-sans mt-2">
            ...
            <div className="relative">
              ...
              <div className="space-y-1.5">
                <span className="font-mono  font-bold text-zinc-450">2011 — 2018</span>
                ...
                <p className="text-zinc-400  font-mono uppercase tracking-widest">Regional Enterprise Software Labs</p>
                <p className="text-zinc-400  leading-relaxed font-sans mt-2">
          ...
          <div className="space-y-4">
            {profile.techStack.map((stack, idx) => (
              <div key={idx} className="p-4 rounded-sm border border-white/5 bg-white/[0.01]">
                <h4 className="font-display font-bold text-[16px] uppercase text-zinc-400 tracking-widest mb-3">
                  {stack.category}
                </h4>
                <div className="flex flex-wrap gap-1.5">
                  {stack.items.map((skill, i) => (
                    <span
                      key={i}
                      className="rounded-sm bg-[#0a0a0a] border border-white/5 px-2.5 py-1 font-mono text-[14px] text-zinc-400 hover:border-orange-500/30 transition-colors"
                    >
                      {skill}
                    </span>
                  ))}
