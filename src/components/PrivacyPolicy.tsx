      ...
      <div className="space-y-12">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-5 rounded-sm border border-white/5 bg-[#0a0a0a]">
              <h4 className="font-mono text-[16px] text-zinc-200 uppercase tracking-widest font-bold mb-2">OAuth Integrations</h4>
              <p className=" text-zinc-400 leading-relaxed">
        ...
        <div className="p-6 rounded-sm border border-white/5 bg-white/[0.01] space-y-4">
          ...
          <div className="p-4 bg-zinc-950 rounded border border-white/[0.03] space-y-2">
            <h4 className="font-mono text-[16px] uppercase text-orange-400 tracking-widest font-bold">Encrypted Memory Buffers</h4>
            <p className=" text-zinc-400 leading-relaxed">
