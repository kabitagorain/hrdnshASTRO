...
export default function TermsOfService({ onBackToHome }: TermsOfServiceProps) {
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 min-h-screen font-sans text-zinc-300" id="terms-of-service-container">
      {/* Meta indicator tag */}
      ...
      <div className="space-y-12">
        ...
        <div className="p-6 rounded-sm border border-white/5 bg-white/[0.01]">
          ...
          <p className=" leading-relaxed text-zinc-400 space-y-2">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-5 rounded-sm border border-white/5 bg-[#0a0a0a]">
              <h4 className="font-mono text-[16px] text-zinc-200 uppercase tracking-widest font-bold mb-2">Engaged Work-Products</h4>
            ...
            <div className="p-5 rounded-sm border border-white/5 bg-[#0a0a0a]">
              <h4 className="font-mono text-[16px] text-zinc-200 uppercase tracking-widest font-bold mb-2">Pre-Existing Core Blueprints</h4>
              <p className=" text-zinc-400 leading-relaxed">
